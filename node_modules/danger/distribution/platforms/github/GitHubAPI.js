...
var GitHubNodeAPI = require("github");
...
var GitHubAPI = /** @class */ (function () {
    ...
    GitHubAPI.prototype.getDangerCommentIDs = function (dangerID) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    GitHubAPI.prototype.getAllOfResource = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    GitHubAPI.prototype.updateStatus = function (passed, message, url) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // API Helpers
    GitHubAPI.prototype.api = function (path, headers, body, method, suppressErrors) {
        ...
        return this.fetch(url, {
            method: method,
            body: body,
            headers: __assign({ "Content-Type": "application/json" }, headers, this.additionalHeaders, customAccept),
        }, suppressErrors);
    };
    ...
    GitHubAPI.prototype.post = function (path, headers, body, suppressErrors) {
        if (headers === void 0) { headers = {}; }
        if (body === void 0) { body = {}; }
