...
function gitDSLForGitHub(api) {
    return __awaiter(this, void 0, void 0, function () {
        var diff, fileDiffs, addedDiffs, removedDiffs, modifiedDiffs, getCommits;
...
exports.gitJSONToGitDSL = function (github, json, githubAPI) {
    /**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, github.utils.fileContents(filename, github.pr.base.repo.full_name, github.pr.base.sha)];
                case 1:
                    baseFile = _a.sent();
                    return [4 /*yield*/, github.utils.fileContents(filename, github.pr.head.repo.full_name, github.pr.head.sha)
    ...
    var diffForFile = function (filename) { return __awaiter(_this, void 0, void 0, function () {
        var ghAPI, diff, fileDiffs, structuredDiff, allLines, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ghAPI = githubAPI ||
                        new GitHubAPI_1.GitHubAPI({ repoSlug: github.pr.head.repo.full_name, pullRequestID: String(github.pr.number) }, process.env["DANGER_GITHUB_API_TOKEN"]);
                    return [4 /*yield*/, ghAPI.getPullRequestDiff()];
                case 1:
                    diff = _b.sent();
                    fileDiffs = parseDiff(diff);
