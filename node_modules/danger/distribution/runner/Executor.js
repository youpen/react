        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (this.options.jsonOnly) {
                    ...
                    table = [
                        { name: "Failures", messages: fails.map(function (f) { return f.message; }) },
                        { name: "Warnings", messages: warnings.map(function (w) { return w.message; }) },
                        { name: "Messages", messages: messages.map(function (m) { return m.message; }) },
                    ...
                    if (fails.length > 0) {
                        ...
                        message = chalk_1.default.underline("Failing the build");
