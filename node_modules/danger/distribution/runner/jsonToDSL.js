...
exports.jsonToDSL = function (dsl) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        api = githubAPIForDSL(dsl);
        github = GitHub_1.githubJSONToGitHubDSL(dsl.github, api);
        git = GitHubGit_1.gitJSONToGitDSL(github, dsl.git);
        return [2 /*return*/, {
                git: git,
                github: github,
                utils: {
...
var githubAPIForDSL = function (dsl) {
